...
/** Get email to view */
$email = $_GET['email'];
if(!$email) header("Location: ManageCustomers.php");
    ...
    <div class="container">
        ...
        <hr>
         <a href="ManageCustomers.php" class="btn">
            <button type="button" class="btn btn-sm btn-outline-secondary">Back to customer accounts</button>
        </a>
</body>
</html>
_END;

$orders = SearchOrdersByEmail($conn, $email); // Retrieve all previous orders
