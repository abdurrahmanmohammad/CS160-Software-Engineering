...
<body>
    ...
    <form>
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="productNameInput" aria-describedby="productNameHelp" value="some retrived product name" placeholder="Enter product name" required>
        </div>
        <div class="form-group">
            <label for="productAmount">Product Amount</label>
            <input type="number" class="form-control" id="productAmountInput" value="100" placeholder="Amount" required>
        </div>
        <div class="form-group">
